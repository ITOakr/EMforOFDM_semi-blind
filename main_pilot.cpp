...
int main()
{
    ...
    else if (mode_select == 52)
    {
        double dopplerFrequency;
        std::cout << "Enter normalized Doppler f_d*T_s:";
        std::cin >> dopplerFrequency;

        fileName = outputDir + timeStr + "_" + modulationName + "f_dT_s =" + std::to_string(dopplerFrequency) + "_MSE_vs_EbN0_RaghavendraAIC_AllPatterns.csv";
        ofs.open(fileName);
        ...
        for (int EbN0dB = EbN0dBmin; EbN0dB <= EbN0dBmax; EbN0dB += EbN0dBstp) {
            ...
            mse = sim.get_H_MSE_RaghavendraAIC_AllPatterns();
        ...
        auto end = std::chrono::high_resolution_clock::now();
        std::chrono::duration<double> elapsed = end - start;
        std::cout << "Mode 52 Total Execution Time: " << elapsed.count() << " seconds" << std::endl;
    }
    else if (mode_select == 53)
    {
        double dopplerFrequency;
        std::cout << "Enter normalized Doppler f_d*T_s:";
        std::cin >> dopplerFrequency;

        fileName = outputDir + timeStr + "_" + modulationName + "f_dT_s =" + std::to_string(dopplerFrequency) + "_MSE_vs_EbN0_SimplifiedPowerSortGAIC_AllPatterns.csv";
        ofs.open(fileName);
        ...
        for (int EbN0dB = EbN0dBmin; EbN0dB <= EbN0dBmax; EbN0dB += EbN0dBstp) {
            ...
            mse = sim.get_H_MSE_SimplifiedPowerSortGAIC_AllPatterns();
        ...
        auto end = std::chrono::high_resolution_clock::now();
        std::chrono::duration<double> elapsed = end - start;
        std::cout << "Mode 53 Total Execution Time: " << elapsed.count() << " seconds" << std::endl;
    }
    else if (mode_select == 54)
    {
        double dopplerFrequency;
        std::cout << "Enter normalized Doppler f_d*T_s:";
        std::cin >> dopplerFrequency;

        fileName = outputDir + timeStr + "_" + modulationName + "f_dT_s =" + std::to_string(dopplerFrequency) + "_MSE_vs_EbN0_PowerSortGAIC_AllPatterns.csv";
        ofs.open(fileName);
        ...
        for (int EbN0dB = EbN0dBmin; EbN0dB <= EbN0dBmax; EbN0dB += EbN0dBstp) {
            ...
            mse = sim.get_H_MSE_PowerSortGAIC_AllPatterns();
